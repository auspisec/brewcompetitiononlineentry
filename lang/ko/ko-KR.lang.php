...
$label_character_limit = "자 제한 - 공간이 부족할 경우 키워드와 약어를 사용해 주세요.<br>입력된 글자 수: 0";
...
$label_judge_nonbeer = "비맥주 출품작 (미드, 사이더, 쌀 양조주 등) 심사 가능하십니까?";
$label_bjcp_rank = "BJCP 등급";
$label_designations = "자격/직함";
$label_judge_sensory = "Judge with Sensory Training";
$label_judge_pro = "Professional Brewer";
$label_judge_comps = "심사 참여 횟수";
$label_judge_preferred = "선호 스타일";
$label_judge_non_preferred = "비선호 스타일";
$label_waiver = "면책 동의";
...
$label_email = "이메일";
$label_account_registration = "계정 등록";
$label_entry_registration = "출품작 등록";
...
$label_entry_acceptance_rules = "출품 접수 규정";
...
$header_text_005 = "정보가 성공적으로 추가되었습니다.";
$header_text_006 = "정보가 성공적으로 수정되었습니다.";
$header_text_007 = "오류가 발생했습니다.";
$header_text_008 = "다시 시도해 주세요.";
$header_text_009 = "관리자 기능에 접근하려면 관리자 권한이 필요합니다.";
$header_text_010 = "변경할";
$header_text_011 = $label_email;
$header_text_012 = $label_password;
$header_text_013 = "입력하신 이메일 주소는 이미 사용 중입니다. 다른 이메일 주소를 입력해 주세요.";
$header_text_014 = "요청 처리 중 문제가 발생했습니다. 다시 시도해 주세요";
$header_text_015 = "Your current password was incorrect.";
$header_text_016 = "이메일 주소를 입력해 주세요.";
$header_text_017 = "로그인 시도 중 문제가 발생했습니다.";
$header_text_018 = "입력하신 사용자 이름은 이미 사용 중입니다.";
$header_text_019 = "Perhaps you have already created an account?";
$header_text_020 = "If so, log in here.";
$header_text_021 = "입력하신 사용자 이름이 유효한 이메일 형식이 아닙니다.";
$header_text_022 = "올바른 이메일 주소를 입력해 주세요.";
$header_text_023 = "CAPTCHA 인증에 실패했습니다.";
...
$header_text_031 = "";
$header_text_032 = "로그인 시도 중 문제가 발생했습니다.";
$header_text_033 = "이메일 주소와 비밀번호가 정확한지 확인해 주세요.";
...
$header_text_036 = "로그아웃되었습니다.";
$header_text_037 = "다시 로그인하시겠습니까?";
$header_text_038 = "보안 질문의 답변이 시스템에 등록된 정보와 일치하지 않습니다.";
$header_text_039 = "계정에 등록된 이메일 주소로 본인 확인 정보가 발송되었습니다.";
$header_text_040 = "다음 수신자에게 메시지가 전송되었습니다:";
$header_text_041 = $header_text_023;
$header_text_042 = "이메일 주소가 변경되었습니다.";
$header_text_043 = "비밀번호가 변경되었습니다.";
$header_text_044 = "정보가 성공적으로 삭제되었습니다.";
$header_text_045 = "BeerXML을 통해 가져온 모든 출품작의 정보를 확인하시기 바랍니다.";
$header_text_046 = "등록이 완료되었습니다.";
$header_text_047 = "최대 출품 한도에 도달했습니다.";
$header_text_048 = "출품작이 추가되지 않았습니다.";
$header_text_049 = "해당 하위 카테고리의 출품 한도에 도달했습니다.";
...
$header_text_059 = "BeerXML로 출품작 가져오기";
$header_text_060 = "출품작이 기록되었습니다.";
$header_text_061 = "출품작이 확정되었습니다.";
$header_text_065 = "All received entries have been checked and those not assigned to tables have been assigned.";
$header_text_066 = "정보가 성공적으로 업데이트되었습니다.";
...
$header_text_103 = "계정에 접속하려면 로그인해 주세요.";
$header_text_104 = "You do not have sufficient access privileges to view this page.";
$header_text_105 = "출품작의 접수 및 확정을 위해 추가 정보가 필요합니다.";
$header_text_106 = "아래 빨간색으로 강조 표시된 부분을 확인해 주세요.";
$header_text_107 = "스타일을 선택해 주세요.";
...
$header_text_109 = "스튜어드(진행 요원)로 등록되었습니다.";
...
$alert_text_027 = "출품작 접수가 아직 시작되지 않았습니다.";
$alert_text_028 = "출품작 등록: 마감.";
$alert_text_029 = "현재 출품작을 추가할 수 없습니다.";
$alert_text_030 = "The competition entry limit has been reached.";
$alert_text_031 = "Your personal entry limit has been reached.";
$alert_text_032 = $entry_open."부터 출품작을 등록하실 수 있습니다.";
$alert_text_033 = "계정 등록은 ".$reg_open."에 시작됩니다.";
$alert_text_034 = "해당 일자에 다시 방문하여 계정을 등록해 주시기 바랍니다.";
$alert_text_036 = "출품작 등록이 가능합니다: ".$entry_open.".";
$alert_text_037 = "해당 일자에 다시 방문하여 시스템에 출품작을 등록해 주시기 바랍니다.";
$alert_text_039 = "심사위원 및 스튜어드 등록 시작: ".$judge_open.".";
$alert_text_040 = "해당 일자에 다시 방문하여 심사위원 또는 스튜어드로 등록해 주시기 바랍니다.";
$alert_text_042 = "출품작 등록: 가능";
$alert_text_043 = $current_time." 기준 시스템에 총 ".$total_entries."개의 출품작이 등록되었습니다.";
$alert_text_044 = "접수 마감일: ";
...
$alert_text_060 = "총 ".$total_entries."개의 출품작이 시스템에 추가되었습니다.";
$alert_text_062 = "출품작 접수가 마감되었습니다";
$alert_text_063 = "접수처에서 더 이상 출품작을 받지 않습니다.";
...
$brew_text_004 = "세부 종류, 특수 부재료, 클래식 스타일, 알코올 도수 및/또는 색상을 기재해야 합니다";
$brew_text_005 = "알코올 도수 필수"; // missing punctuation intentional
$brew_text_006 = "탄산화 정도 필수"; // missing punctuation intentional
$brew_text_007 = "당도 필수"; // missing punctuation intentional
$brew_text_008 = "이 스타일은 출품 시 특정 정보의 추가 기재가 필요합니다.";
$brew_text_009 = "해당 스타일 필수 입력 사항"; // missing punctuation intentional
...
$brew_text_012 = "***선택 입력*** 출품작 평가와 채점 시 심사위원이 참고하길 원할 경우에만 작성해 주십시오. 다른 항목에 기재하지 않은, 심사 시 고려되길 바라는 구체적인 내용을 적어 주시면 됩니다. (예: 매싱 기법, 홉 품종, 꿀 종류, 포도 품종, 배 품종 등)";
...
$brewer_text_007b = "비맥주 출품작 (미드, 사이더, 쌀 양조주 등) 심사에 응해 주시겠습니까? '예'로 응답한 심사위원은 해당 카테고리 심사를 요청받을 수 있습니다.";
$brewer_text_008 = "* <em>Non-BJCP</em> 등급은 BJCP 맥주 심사위원 입문 시험(Entrance Exam)을 치르지 않았으며, 프로 양조사(Professional Brewer)가 <em>아닌</em> 경우에 해당합니다.";
$brewer_text_009 = "** <em>Provisional(임시)</em> 등급은 BJCP 맥주 심사위원 입문 시험(Entrance Exam)에 합격했으나, 아직 BJCP 맥주 심사 실기 시험(Judging Exam)을 치르지 않은 경우에 해당합니다.";
$brewer_text_010 = "인쇄되는 채점표(Scoresheet) 라벨에는 선택하신 자격 중 처음 2개 항목만 표시됩니다.";
$brewer_text_011 = "이전까지 심사위원으로 참여한 대회는 총 몇 회입니까?";
$brewer_text_012 = "선호하는 스타일만 체크해 주십시오. 체크하지 않은 스타일도 심사가 가능한 것으로 간주되므로, 심사 가능한 모든 스타일에 일일이 체크하실 필요는 없습니다.";
$brewer_text_013 = "위 버튼을 클릭하거나 탭하여 비선호하는 심사 스타일 목록을 펼치십시오.";
$brewer_text_014 = "본인이 출품한 스타일을 별도로 표시하실 필요는 없습니다. 시스템상 본인의 출품작이 있는 테이블에는 본인이 배정되지 않도록 자동 처리됩니다.";
$brewer_text_015 = "스튜어드로 지원하시겠습니까?";
$brewer_text_016 = "본 심사 참여는 전적으로 자발적인 것입니다. 저는 본 심사에 참여하는 과정에서 주류를 섭취하게 되며, 이 섭취가 제 인식과 반응에 영향을 줄 수 있음을 인지하고 있습니다.<p></p>";
$brewer_text_017 = "위 버튼을 클릭하거나 탭하여 선호하는 심사 스타일 목록을 펼치십시오.";
 ...
 * ------------------------------------------
 */
$contact_text_000 = "대회 관련 문의는 아래 링크를 통해 담당자에게 연락해 주시기 바랍니다:";
$contact_text_001 = "아래 양식을 사용하여 대회 담당자에게 연락할 수 있습니다. 별표가 표시된 모든 항목은 필수 입력 사항입니다.";
$contact_text_002 = "Additionally, a copy has been sent to the email address you provided.";
$contact_text_003 = "추가 메시지를 보내시겠습니까?";
...
$default_page_text_006 = "환영합니다! 오늘의 브루어:";
...
$default_page_text_013 = "대회 주최자";
$default_page_text_014 = "대회 주최자";
...
$reg_open_text_000 = "심사위원 및 스튜어드 등록:";
$reg_open_text_001 = "가능";
$reg_open_text_002 = "자원봉사를 원하시면 등록해주세요";
$reg_open_text_003 = "";
...
$judge_closed_000 = "S.A.A.Z. Seoul Cup에 참가해 주신 모든 분들께 감사드립니다.";
$judge_closed_001 = "총";
...
$entry_info_text_031 = "계정을 만들고 출품작을 등록한 후에는 출품료를 납부해야 합니다.";
...
$entry_info_text_036 = "택배 접수처 출품작 수령 기간:";
$entry_info_text_037 = "출품작 보내실 곳:";
...
$entry_info_text_043 = "방문 접수처 출품작 접수 기간:";
$entry_info_text_044 = "Map to";
$entry_info_text_045 = "Select/Tap for Required Entry Info";
$entry_info_text_046 = "스타일 이름이 링크로 표시되면 별도의 출품 요건이 있습니다. 확인하려면 해당 이름을 선택하거나 탭하세요.";
...
$pay_text_015 = "위 금액을 아래 계좌로 은행 이체해 주십시오:";
$label_bank = "은행";
$label_account_number = "계좌번호";
$label_account_holder = "수취인";
...
$register_text_018 = "하나를 선택해 주세요. 이 질문은 비밀번호 분실 시 본인 확인을 위해 사용됩니다.";
 ...
 * ------------------------------------------
 */
$volunteers_text_000 = "이미 등록하셨다면, ";
$volunteers_text_001 = "하시고 '내 계정' 메뉴에서 '계정 수정'을 ";
$volunteers_text_002 = " 선택해주세요";
$volunteers_text_003 = "&";
$volunteers_text_004 = "자원봉사를 원하시면 등록해주세요";
...
$label_varies = "Varies";
$label_styles_accepted = "출품 가능 스타일";
...
$brew_text_028 = "***필수 아님*** 스타일 가이드라인에 따라 선택적으로 기재할 수 있는 특성이 있다면 이곳에 추가해 주세요.";
...
$brew_text_038 = "이 출품작에 알레르기 유발 가능 식품이 포함되어 있습니까? 대표적인 알레르기 유발 식품에는 우유(유당 포함), 계란, 생선, 갑각류, 견과류, 땅콩, 밀, 대두 등이 있습니다. 비(非)맥주 스타일의 경우, 발효 원료에 글루텐이 포함될 수 있거나(예: 보리, 밀, 호밀 맥아), 양조 효모를 사용한 경우에는 글루텐을 알레르기 항목으로 명시해야 합니다. 맥주 스타일의 경우에는 글루텐이 기본적으로 함유된 것으로 간주되므로 따로 명시할 필요가 없습니다.";
...
$brewer_text_023 = "가입한 클럽이 없다면 \"None\"을, 클럽이 목록에 없다면 \"Other\"를 선택하시고, <strong>검색창을 꼭 이용해 주세요</strong>.";
...
$brewer_text_035 = "BJCP 사이더(Cider) 심사위원 시험에 합격하셨습니까?";
...
else $brewer_info_000 = "다음 대회에 참여해 주셔서 감사합니다:";
...
$pay_text_032 = "결제하실 필요가 없습니다. 감사합니다!";
...
$login_text_018 = "사용자 이름은 필수 항목입니다.";
$login_text_019 = "비밀번호는 필수 항목입니다.";
$login_text_020 = "제공된 토큰이 유효하지 않거나 이미 사용되었습니다. '비밀번호 찾기' 기능을 다시 사용하여 새로운 비밀번호 재설정 토큰을 발급받아 주세요.";
$login_text_021 = "제공된 토큰이 만료되었습니다. '비밀번호 찾기' 기능을 다시 사용하여 새로운 비밀번호 재설정 토큰을 발급받아 주세요.";
$login_text_022 = "The email you entered is not associated with the provided token. Please try again.";
$login_text_023 = "비밀번호가 일치하지 않습니다. 다시 시도해 주세요.";
$login_text_024 = "비밀번호 확인은 필수 항목입니다.";
 ...
 * ------------------------------------------
 */
$entry_info_text_048 = "정확한 심사를 위해 출품자는 출품작에 대한 추가 정보를 기재해야 합니다.";
$entry_info_text_049 = "정확한 심사를 위해 출품자는 출품작의 알코올 강도를 기재해야 합니다.";
$entry_info_text_050 = "정확한 심사를 위해 출품자는 출품작의 탄산화 정도를 기재해야 합니다.";
$entry_info_text_051 = "정확한 심사를 위해 출품자는 출품작의 당도를 기재해야 합니다.";
...
$label_this_style = "이 스타일"; // This Style - Link to ?
$label_notes = "Notes";
...
$brew_text_040 = "모든 맥주에는 기본적으로 글루텐이 포함되어 있는 것으로 간주되므로, 알레르기 유발 물질로 글루텐을 따로 명시할 필요는 없습니다.";
...
$brewer_info_013 = "심사위원으로 배정되었습니다.";
...
$label_auto_log_out = "자동 로그아웃까지 남은 시간:";
...
$label_session_expire = "세션이 곧 만료됩니다";
$label_refresh = "페이지 새로고침";
$label_stay_here = "이 페이지에 머물기";
...
$alert_text_090 = "2분 후 세션이 만료됩니다. 시간이 만료되기 전까지 현재 페이지에 머물러 작업을 완료하거나, 새로고침하여 세션을 연장하거나, 로그아웃할 수 있습니다.";
$alert_text_091 = "30초 후 세션이 만료됩니다. 새로고침하여 세션을 연장하거나 로그아웃할 수 있습니다.";
...
$label_semi_dry = "미디엄 드라이";
$label_semi_sweet = "미디엄 스위트";
 ...
 * ------------------------------------------
 */
$label_regional_variation = "지역 변형";
...
$brew_text_043 = "숫자만 입력하세요 – 소수 둘째 자리까지 입력 가능 (예: 5.2, 12.84 등).";
$brew_text_044 = "최종 비중을 소수 셋째 자리까지 입력해 주십시오 (예: 0.991, 1.000, 1.007 등).";
...
$brew_text_049 = "출품작을 따르는 방법이나 기타 관련 사항에 대해 추가 정보를 제공해 주십시오. (예: 거품이 과도하게 발생할 가능성 등)";
$brewer_text_055 = "관련된 양조 파트너가 있다면 선택해 주십시오. 이는 심사위원과 스튜어드 배정 시 이해 충돌이 발생하지 않도록 하기 위한 것입니다."; 
$brewer_text_054 = "<strong>함께 양조했거나 연관이 있는 모든 양조 파트너를 입력해 주십시오. 이는 심사위원 및 스튜어드 배정 시 출품작 심사의 이해충돌을 방지하기 위함입니다. 여기에 대상자의 성명 전체(풀네임)를 입력해 주십시오 (예: 홍길동, 김철수, John Doe 등). 양조 팀명이 있다면 함께 작성해 주십시오.</strong> 이름이나 팀명은 쉼표(,) 또는 세미콜론(;)으로 구분해 주십시오. 큰따옴표(&quot;) 및 퍼센트(&#37;)를 포함한 일부 특수문자는 입력할 수 없습니다.";
...
$form_required_fields_01 = "값이 입력되지 않은 필수 항목은 위에서 별표<i class=\"fa fa-sm fa-star\"></i>나 <strong class=\"text-danger\">빨간색으로</strong> 표시되어 있습니다. 필요하면 위로 스크롤해 주세요.";
