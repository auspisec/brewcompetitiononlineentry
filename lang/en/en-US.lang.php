...
$label_judge_nonbeer = "Willing to judge non-beer entries (i.e., Mead, Cider, Rice Brew)?";
...
$brewer_text_007b = "Are you willing to judge non-beer entries (i.e., Mead, Cider, Rice Brew)? Judges who answer Yes may be asked to judge these categories.";
...
$pay_text_015 = "Please transfer the above amount to the bank account below: <p><ul><li>Bank: XX</li><li>Account Number: #######-#######</li><li>Recipient: NAMEHERE</li></ul></p>";
