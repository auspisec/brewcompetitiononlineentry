 ...
 *
 * Seoul Cup: printed output (entry labels) must be uniform regardless of
 * which language the requesting user has chosen in the UI, so labels are
 * always rendered in the site default. This helper reads prefsLanguage
 * (and derives the folder) straight from the preferences table.
 *
